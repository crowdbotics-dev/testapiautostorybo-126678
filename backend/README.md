...
## Project Structure
    ...
    ├── testapiautostorybo_126678  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_126678`
...
2. Clone this repo and `cd testapiautostorybo_126678`
